"""
KP 1-soliton architecture sweep.
...
results_csv = results_root / "results-kp-1-soliton-architecture.csv"
...
for idx, (n_layers, n_neurons, seed) in enumerate(pending, 1):
    ...
    try:
        ...
        # KP stores loss history rather than a final_loss attribute
        ...
        # compute max error from the error tensor
