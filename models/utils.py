...
def log_gpu_memory(tag: str = '', 
                   device: torch.DeviceLikeType = None
                   ) -> None:
    """
    Print the gpu memory utilization statistics
    """
...
def print_weighted_loss_components(loss_weights: torch.Tensor,
                                   loss_comps: torch.Tensor,
                                   tag: str = ''
                                   ) -> None:
    """
    Print the weighted loss components formatted
    """
